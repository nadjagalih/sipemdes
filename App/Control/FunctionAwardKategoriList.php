            ...
            <div class="row">
                ...
                <div class="col-md-2 text-center">
                    <div style="padding-top: 5px;">
                        <span class="label <?php echo $badgeAward; ?>" style="display: block; margin-bottom: 8px; padding: 4px 8px;">
                            Award <?php echo $StatusAward; ?>
                        </span>
                        <div class="row">
                            <div class="col-xs-6">
                                <h5 class="font-bold text-navy" style="margin: 0;"><?php echo $totalPeserta; ?></h5>
                                <small>Peserta</small>
                            </div>
                            <div class="col-xs-6">
                                <h5 class="font-bold text-primary" style="margin: 0;"><?php echo $pesertaBerposisi; ?></h5>
                                <small>Berposisi</small>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li>
                                <a href="?pg=KategoriDetail&Kode=<?php echo $IdKategoriAward; ?>">
                                    <i class="fa fa-eye text-info"></i> Detail & Peserta
                                </a>
                            </li>
                            <li>
