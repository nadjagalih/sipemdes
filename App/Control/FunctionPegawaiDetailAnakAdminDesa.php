...
?>
        <tr class="gradeX">
            ...
            <td>
                <a href="?pg=PegawaiEditAnakAdminDesa&Kode=<?php echo $IdAnak; ?>">
                    <button class="btn btn-outline btn-success btn-xs" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></button>
                </a>
                <a href="../App/Model/ExcPegawaiAnakAdminDesa?Act=Delete&Kode=<?php echo $IdAnak; ?>" onclick="return confirm('Anda yakin ingin menghapus : <?php echo $Nama; ?> ?');">
