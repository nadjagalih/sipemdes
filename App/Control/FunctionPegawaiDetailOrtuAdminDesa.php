...
?>
        <tr class="gradeX">
            ...
            <td>
                <a href="?pg=PegawaiEditOrtuAdminDesa&Kode=<?php echo $IdOrtu; ?>">
                    <button class="btn btn-outline btn-success btn-xs" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></button>
                </a>
                <a href="../App/Model/ExcPegawaiOrtuAdminDesa?Act=Delete&Kode=<?php echo $IdOrtu; ?>" onclick="return confirm('Anda yakin ingin menghapus : <?php echo $Nama; ?> ?');">
