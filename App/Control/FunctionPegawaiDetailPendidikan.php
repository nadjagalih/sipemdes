...
?>
        <tr class="gradeX">
            ...
            <td>
                <?php if ($Setting == 0) { ?>
                    <a href="../App/Model/ExcPegawaiPendidikan?Act=SettingOn&Kode=<?php echo $IdPendidikanV; ?>">
            ...
            <td>
                <a href="?pg=PegawaiEditPendidikan&Kode=<?php echo $IdPendidikanV; ?>">
                    <button class="btn btn-outline btn-success btn-xs" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></button>
                </a>
                <a href="../App/Model/ExcPegawaiPendidikan?Act=Delete&Kode=<?php echo $IdPendidikanV; ?>" onclick="return confirm('Anda yakin ingin menghapus : <?php echo $NamaSekolah; ?> ?');">
