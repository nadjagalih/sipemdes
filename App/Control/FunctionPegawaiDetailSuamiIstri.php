...
?>
        <tr class="gradeX">
            ...
            <td>
                <a href="?pg=PegawaiEditSuamiIstri&Kode=<?php echo $IdSuamiIstri; ?>">
                    <button class="btn btn-outline btn-success btn-xs" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></button>
                </a>
                <a href="../App/Model/ExcPegawaiSuamiIstri?Act=Delete&Kode=<?php echo $IdSuamiIstri; ?>" onclick="return confirm('Anda yakin ingin menghapus : <?php echo $Nama; ?> ?');">
