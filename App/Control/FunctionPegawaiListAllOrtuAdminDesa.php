...
?>
    <tr class="gradeX">
        ...
        <td>
            <a href="?pg=PegawaiDetailOrtuAdminDesa&Kode=<?php echo $IdPegawaiFK; ?>" class=" float-center" data-toggle="tooltip" title="Detail Data"><?php echo $NIK; ?></a>
        </td>
        <td>
        ...
        <td>
            <?php if ($IdPegawaiFK == $_SESSION['IdUser']) { ?>
                ...
                ?>
                    <a href="?pg=PegawaiAddOrtuAdminDesa&Kode=<?php echo $IdPegawaiFK; ?>">
