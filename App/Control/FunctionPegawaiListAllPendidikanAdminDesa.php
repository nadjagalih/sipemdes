...
WHERE master_pegawai.Setting <> 0 and
...
?>
    <tr class="gradeX">
        ...
        <td>
            <a href="?pg=PegawaiDetailPendidikanAdminDesa&Kode=<?php echo $IdPegawaiFK; ?>" class=" float-center" data-toggle="tooltip" title="Detail Data"><?php echo $NIK; ?></a>
        </td>
        <td>
        ...
        <td>
            <?php if ($IdPegawaiFK == $_SESSION['IdUser']) { ?>
                ...
                ?>
                    <a href="?pg=PegawaiAddPendidikanAdminDesa&Kode=<?php echo $IdPegawaiFK; ?>">
