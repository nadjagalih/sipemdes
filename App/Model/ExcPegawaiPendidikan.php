...
if (empty($_SESSION['NameUser']) && empty($_SESSION['PassUser'])) {
    ...
    if ($_GET['Act'] == 'Save') {
        if (isset($_POST['Save'])) {
            ...
            if ($Save) {
                header("location:../../View/v?pg=PegawaiViewPendidikan&alert=Save");
            }
        }
        ...
        if (isset($_POST['Edit'])) {
            ...
            if ($Edit) {
                header("location:../../View/v?pg=PegawaiViewPendidikan&alert=Edit");
            }
        }
        ...
        if (isset($_GET['Kode'])) {
            ...
            if ($Delete) {
                header("location:../../View/v?pg=PegawaiViewPendidikan&alert=Delete");
            }
        }
        ...
        if (isset($_GET['Kode'])) {
            ...
            if ($SettingAktif) {
                header("location:../../View/v?pg=PegawaiViewPendidikan&alert=Setting");
            }
        }
    }
}
