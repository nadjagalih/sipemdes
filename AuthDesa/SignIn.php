<?php
/**
 * SignIn AuthDesa - All in One Style
...
if (!RateLimiter::checkLimit('login_desa_' . $clientIP, 5, 900)) { // 5 attempts per 15 minutes
        ...
        if ($stmt = mysqli_prepare($db, $query)) {
            ...
            if (password_verify($password, $data['NamePassword'])) {
                if ($data['StatusLogin'] == 0) {
                    ...
                    if ($data['IdLevelUserFK'] == 2) { // Level 2 untuk Desa
                        // Set session
                        session_start();
                        ...
                        $message = 'Level user tidak sesuai untuk akses Desa!';
                        $messageType = 'error';
                    }
                }
            } else {
...
<head>
    ...
    <style>
        ...
        .login-container::before {
            ...
            right: 0;
            height: 5px;
            background: linear-gradient(90deg, #3498db, #2980b9, #74b9ff, #0984e3);
...
<body>
    <div class="login-container">
        <div class="logo-section">
            ...
            <div class="title-unit">Unit Akses Desa</div>
        </div>
