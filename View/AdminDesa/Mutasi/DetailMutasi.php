        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <a href="?pg=ViewMutasiAdminDesa" class="btn btn-primary float-center"> Batal</a>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-kecamatan">
                                ...
                                <tbody>
                                    ...
                                    $QMutasiView = mysqli_query($db, "SELECT
                                        ...
                                        history_mutasi.FileSKMutasiBlob
                                        FROM history_mutasi
                                    ...
                                    while ($DataView = mysqli_fetch_assoc($QMutasiView)) {
                                        ...
                                        $FileSKMutasiBlob = $DataView['FileSKMutasiBlob'];
                                        ?>
                                        <tr class="gradeX">
                                            <td><?php echo $No; ?> </td>
                                            ...
                                            <td>Nomor SK : <?php echo $NomorSK; ?>
                                                ...
                                                <?php if (is_null($FileSKMutasiBlob)) {
                                                    ...
                                                    ?>
                                                    <a target='_BLANK'
                                                        href='../Module/File/ViewFileSKMutasi?id=<?php echo $IdMutasi; ?>'>Lihat
                                                        File SK</a>
                                                    <?php
                                                }
                                                ?>
                                            ...
                                            <td>
                                                <?php if ($SetMutasi == 0) { ?>
                                                    <a
                                                        href="../App/Model/ExcHistoryMutasi?Act=SettingOn&Kode=<?php echo $IdMutasi; ?>">
                                            ...
                                            <td>
                                                <?php if ($SetMutasi == 0) { ?>
                                                    <button type="button" class="btn btn-outline btn-default"><i
                                                ...
                                                <?php } elseif ($SetMutasi == 1) { ?>
                                                    <a href="?pg=EditMutasiAdminDesa&Kode=<?php echo $IdMutasi; ?>">
                                                        <button class="btn btn-outline btn-success btn-md" data-toggle="tooltip"
                                                            title="Edit Data"><i class="fa fa-edit"></i></button>
                                                    </a>
                                                    <a href="?pg=EditMutasiSKAdminDesa&Kode=<?php echo $IdMutasi; ?>">
                                                        <button class="btn btn-outline btn-success btn-md" data-toggle="tooltip"
                                                            title="Upload SK"><i class="fa fa-book"></i></button>
                                                    </a>
                                                    <a href="../App/Model/ExcHistoryMutasiAdminDesa?Act=Delete&Kode=<?php echo $IdMutasi; ?>"
                                                        onclick="return confirm('Anda yakin ingin menghapus : <?php echo $IdMutasi; ?> ?');">
                                                        <button class="btn btn-outline btn-danger  btn-md" data-toggle="tooltip"
                                                            title="Delete"><i class="fa fa-eraser"></i></button>
                                                    </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
