                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row"><label class="col-lg-3 col-form-label">Tempat Lahir<span style="font-style: italic; color:red">*</span></label>
                                    <div class="col-lg-8">
                                        <input type="text" name="TempatLahir" id="TempatLahir" value="<?php echo $TempatLahir; ?>" placeholder="Masukkan Tempat Lahir" class="form-control" autocomplete="off" required>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <a href="?pg=PegawaiViewAllAdminDesa" class="btn btn-success ">Batal</a>
                            </div>
                        </div>
                    </form>
                </div>
