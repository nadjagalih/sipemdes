        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Form Input BPD</h5>&nbsp;<span style="font-style: italic; color:red">*) Wajib Diisi</span>
                </div>
                <div class="ibox-content">
                    <form action="../App/Model/ExcPegawaiBPDAdminDesa?Act=Add" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group row"><label class="col-lg-3 col-form-label">NIK<span style="font-style: italic; color:red">*</span></label>
                                    ...
                                    <div class="col-lg-8"><input type="text" name="NIK" id="NIK" placeholder="Masukkan NIK" class="form-control" autocomplete="off" required onkeypress="return hanyaAngka(event)">
                                    </div>
                                </div>
                                <div class="form-group row"><label class="col-lg-3 col-form-label">Nama<span style="font-style: italic; color:red">*</span></label>
                                    <div class="col-lg-8"><input type="text" name="Nama" id="Nama" placeholder="Masukkan Nama" class="form-control" autocomplete="off" required maxlength="100">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row"><label class="col-lg-3 col-form-label">Alamat<span style="font-style: italic; color:red">*</span></label>
                                    <div class="col-lg-8"><input type="text" name="Alamat" id="Alamat" placeholder="Masukkan Alamat" class="form-control" autocomplete="off" required>
                                    </div>
                                </div>
                                <div class="form-group row"><label class="col-sm-3 col-form-label">RT / RW<span style="font-style: italic; color:red">*</span></label>
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <input type="text" name="RT" id="RT" placeholder="RT" class="form-control" autocomplete="off" required>
                                            </div><span style="font-style: italic;">/</span>
                                            <div class="col-md-3">
                                                <input type="text" name="RW" id="RW" placeholder="RW" class="form-control" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row"><label class="col-lg-3 col-form-label">Kelurahan/Desa<span style="font-style: italic; color:red">*</span></label>
                                    <div class="col-lg-8">
                                        <?php include "../App/Control/FunctionSelectDesaAdd.php"; ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row"><label class="col-lg-3 col-form-label">Golongan Darah<span style="font-style: italic; color:red">*</span></label>
                                    <div class="col-lg-8">
                                        <?php include "../App/Control/FunctionSelectGolDarahAdd.php"; ?>
                                    </div>
                                </div>
                                <div class="form-group row"><label class="col-lg-3 col-form-label">Status Pernikahan<span style="font-style: italic; color:red">*</span></label>
                                    <div class="col-lg-8">
                                        <?php include "../App/Control/FunctionSelectPernikahanAdd.php"; ?>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group row"><label class="col-lg-3 col-form-label">Status Kepegawaian<span style="font-style: italic; color:red">*</span></label>
                                    <div class="col-lg-8">
                                        <?php include "../App/Control/FunctionSelectStatusPegawaiAdd.php"; ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row"><label class="col-lg-3 col-form-label">Telp</label>
                                    <div class="col-lg-8"><input type="text" name="Telp" id="Telp" placeholder="Masukkan No Telp" class="form-control" autocomplete="off">
                                    </div>
                                </div>
                                <div class="form-group row"><label class="col-lg-3 col-form-label">Email</label>
                                    <div class="col-lg-8"><input type="email" name="Email" id="Email" placeholder="user@example.com" class="form-control" autocomplete="off">
                                    </div>
                                </div>
