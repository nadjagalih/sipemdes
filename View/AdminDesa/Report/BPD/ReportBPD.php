...
<div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    ...
                    <div class="text-left">
                        <a href="AdminDesa/Report/Pdf/BPDFilterDesaPdf" target="_BLANK">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Data BPD Desa <?php echo htmlspecialchars(NamaDesa); ?> Kecamatan <?php echo htmlspecialchars(NamaKecamatan); ?> Kabupaten <?php echo htmlspecialchars(Kabupaten); ?></h5>
                    <div class="ibox-tools">
                        <a class="collapse-link">
                            <i class="fa fa-chevron-up"></i>
                        </a>
