...
$content =
    '<html>
            <body>
            <h4>Data Masa Pensiun Perangkat Desa' . " " . $NamaDesa . " " . 'Kecamatan' . " " . $NamaKecamatan . ' Kabupaten ' . $Kabupaten . '<br>Pertanggal ' . $Tanggal_Cetak . ' Pukul ' . $Waktu_Cetak . ' WIB</h4>
...
while ($DataPegawai = mysqli_fetch_assoc($QueryPegawai)) {
    ...
    $content .=
        '<br>' . $JenisKelamin . '</td>
                <td width="90">' . $ViewTglPensiun . '</td>
                <td width="90">' . $HasilTahun . '<br>' . $HasilBulan . '<br>' . $HasilHari . '</td>';
