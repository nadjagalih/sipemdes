<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Data Pemerintah Desa Pensiun</h2>
    </div>
    <div class="col-lg-2">
...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="col-lg-12">
        <div class="ibox ">
            <div class="ibox-title">
                <h5>Filter Data Pemerintah Desa Pensiun</h5>
            ...
            <div class="ibox-content">
                ...
                <div class="text-left">
                    <a href="AdminDesa/Report/Pdf/PensiunDesaPdf" target="_BLANK">
    ...
    <div class="col-lg-12">
        <div class="ibox ">
            <div class="ibox-title">
                <h5>List Semua Data Pemerintah Desa Pensiun</h5>
                <div class="ibox-tools">
                    <a class="collapse-link">
                        <i class="fa fa-chevron-up"></i>
                    </a>
