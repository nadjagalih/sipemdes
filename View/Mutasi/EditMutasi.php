...
if (isset($_GET['Kode'])) {
    ...
    $IdPegawaiFK = isset($DataMutasi['IdPeg']) ? $DataMutasi['IdPeg'] : '';
    ...
    if (!empty($TglTMT) && $TglTMT != '0000-00-00') {
        ...
        if (count($exp1) >= 3) {
            ...
            $TanggalTMT = $TglTMT; // gunakan format asli jika tidak bisa di-parse
        }
    } else {
        $TanggalTMT = "";
    }
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form action="../App/Model/ExcHistoryMutasi?Act=Edit" method="POST" enctype="multipart/form-data">
                        <div class="row">
