        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form action="../App/Model/ExcHistoryMutasi?Act=EditSK" method="POST" enctype="multipart/form-data" onsubmit="return validateFile()">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <!-- PREVIEW UPLOAD FOTO -->
                                <div class="form-group row"><label class="col-lg-3 col-form-label">Upload File
                                        SK</label>
                                    <div class="col-lg-8">
