        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form action="../App/Model/ExcPegawaiOrtu?Act=Edit" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                ...
                                <a href="?pg=PegawaiDetailOrtu&Kode=<?php echo $IdPegawaiFK; ?>" class="btn btn-success ">Batal</a>
                            </div>
                        </div>
                    </form>
                </div>
