        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Form Input BPD</h5>&nbsp;<span style="font-style: italic; color:red">*) Wajib Disi</span>
                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-6 b-r">
                            ...
                            <form action="../App/Model/ExcPegawaiBPD?Act=Foto" method="POST" enctype="multipart/form-data">
