        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form action="../App/Model/ExcPegawaiBPD?Act=Add" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row"><label class="col-lg-3 col-form-label">Email</label>
                                    <div class="col-lg-8"><input type="email" name="Email" id="Email" value="<?php echo isset($Email) ? htmlspecialchars($Email) : ''; ?>" placeholder="contoh@gmail.com" class="form-control" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <a href="?pg=PegawaiBPDViewAll" class="btn btn-success ">Batal</a>
                            </div>
                        </div>
                    </form>
                </div>
