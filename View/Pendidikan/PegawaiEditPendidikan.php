        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form action="../App/Model/ExcPegawaiPendidikan?Act=Edit" method="POST" enctype="multipart/form-data">
                        <div class="row">
                                ...
                                <div class="form-group row" id="TanggalLahir">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="input-group date">
                                            ...
                                            <input type="text" name="TanggalIjazah" id="TanggalIjazah" value="<?php echo $TglIjasah; ?>" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
