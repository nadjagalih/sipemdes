...
if (isset($_GET['ExportPDF'])) {
    ...
    if ($AmbilJabatan == 1) {
        ...
        $content =
            '<html>
            <body>
                <h5>Filter Data Siltap Jabatan ' . $Jabatan . ' Dari Siltap Rp. ' . $FormatSiltapAwal . ' Sampai Rp. ' . $FormatSiltapAkhir . ' <br>Kecamatan ' . $NamaKecamatan . ' Kabupaten ' . $Kabupaten . ' <br>Pertanggal ' . $Tanggal_Cetak . ' Pukul ' . $Waktu_Cetak . ' WIB</h5>
        ...
        $QueryPegawai = mysqli_query($db, "SELECT
                                            ...
                                            WHERE
                                                ...
                                                master_pegawai.Siltap BETWEEN '$SiltapAwal' AND '$SiltapAkhir' AND
        ...
        while ($DataPegawai = mysqli_fetch_assoc($QueryPegawai)) {
            ...
            $content .= '<td width="130">' . $NIK . '</td>
                        <td width="280">
                            ...
                            <strong><em>' . $Jabatan . '</em></strong><br><br>' . $Address .
                '</td>
