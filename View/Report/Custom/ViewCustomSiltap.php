                            ...
                            <form action="?pg=ViewCustomSiltap" method="post" enctype="multipart/form-data">
                                <div class="ibox-content">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="tabelSiltap_1">
                                            <thead>
                                                <tr>
                                                    <th>No</th>
                                                    <th>Foto</th>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            ...
                            <form action="?pg=ViewCustomSiltap" method="post" enctype="multipart/form-data">
                                <div class="ibox-content">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="tabelSiltap_2">
                                            <thead>
                                                <tr>
                                                    <th>No</th>
                                                    <th>Foto</th>
...
$(document).ready(function() {
    ...
    if ($('#tabelSiltap_1').length > 0) {
        console.log('Table 1 found, initializing...');
        
        if ($.fn.DataTable.isDataTable('#tabelSiltap_1')) {
            $('#tabelSiltap_1').DataTable().destroy();
        }
        
        var table1 = $('#tabelSiltap_1').DataTable({
        ...
        "buttons": [
            ...
            },
            {
                ...
                action: function (e, dt, node, config) {
                    ...
                    var siltapAwal = '<?php echo isset($SiltapAwal) ? $SiltapAwal : ""; ?>';
                    var siltapAkhir = '<?php echo isset($SiltapAkhir) ? $SiltapAkhir : ""; ?>';
                    ...
                    var pdfUrl = 'Report/Custom/PdfCustomSiltapKecamatan?Kecamatan=' + 
                        encodeURIComponent(kecamatanId) + '&Jabatan=1&SiltapAwal=' + 
                        encodeURIComponent(siltapAwal) + '&SiltapAkhir=' + encodeURIComponent(siltapAkhir) + '&ExportPDF=';
    ...
    if ($('#tabelSiltap_2').length > 0) {
        console.log('Table 2 found, initializing...');
        
        if ($.fn.DataTable.isDataTable('#tabelSiltap_2')) {
            $('#tabelSiltap_2').DataTable().destroy();
        }
        
        var table2 = $('#tabelSiltap_2').DataTable({
        ...
        "buttons": [
            ...
            },
            {
                ...
                action: function (e, dt, node, config) {
                    ...
                    var pdfUrl = 'Report/Custom/PdfCustomSiltapKecamatan?Kecamatan=' + 
                        encodeURIComponent(kecamatanId) + '&Jabatan=2&SiltapAwal=' + 
                        encodeURIComponent(siltapAwal) + '&SiltapAkhir=' + encodeURIComponent(siltapAkhir) + '&ExportPDF=';
                    window.open(pdfUrl, '_blank');
                }
            },
