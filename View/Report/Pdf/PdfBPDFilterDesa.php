...
if (isset($_GET['Proses'])) {
    ...
    $content =
        '<html>
            <body>
            <h4>Data BPD Desa ' . $NamaDesa . ' Kecamatan' . " " . $NamaKecamatan . '<br>Pertanggal ' . $Tanggal_Cetak . ' Pukul ' . $Waktu_Cetak . ' WIB</h4>
                <table  border="0.3" cellpadding="4" cellspacing="0" width="100%">
                    <thead>
                     <tr align="center">
                        <th width="50">No</th>
                        <th width="80">Foto</th>
    ...
    $QueryPegawai = mysqli_query($db, "SELECT
                    ...
                    where master_kecamatan.IdKecamatan = '$Kecamatan' AND
