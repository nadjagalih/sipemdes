...
if (isset($_GET['Kecamatan'])) {
    ...
    $content =
        '<html>
            <body>
            <h4>Data Masa Pensiun Kepala Desa Di Kecamatan' . " " . $NamaKecamatan . ' <br>Pertanggal ' . $Tanggal_Cetak . ' Pukul ' . $Waktu_Cetak . ' WIB</h4>
...
// $html2pdf->output();
$content2pdf->Output('Data Masa Pensiun Kepala Desa Di Kecamatan ' . " " . $NamaKecamatan . '_' . $DateCetak . '.pdf', 'I'); //NAMA FILE, I/D/F/S
?>
