...
$content =
    '<html>
            <body>
            <h4>Data Kepala Desa & Perangkat Desa Kabupaten' . " " . $Kabupaten . '<br>Pertanggal ' . $Tanggal_Cetak . ' Pukul ' . $Waktu_Cetak . ' WIB</h4>
                <table  border="0.3" cellpadding="2" cellspacing="0" width="100%">
                    <thead>
                        <tr align="center">
                            ...
                            <th><strong>SK Pengangkatan<br>No SK<br>Tgl SK</strong></th>
...
while ($DataPegawai = mysqli_fetch_assoc($QueryPegawai)) {
    ...
    $content .=
        '<td width="140">' . $Kecamatan . '<br><strong>' . $NamaDesa . '</strong><br>' . $KodeDesa . '</td>';
    if (empty($Foto)) {
        $content .=
    ...
    $content .=
        '<td width="240"><strong>' . $Nama . '</strong><br><br>' . $Address . '</td>
    ...
    $content .=
        '<td width="80">' . $Pendidikan . '</td>
                <td width="180">' . $NomorSK . '<br><br>' . $TanggalMutasi . '</td>
                <td width="180">' . $Jabatan . ' ' . $KetJabatan . '</td>
                <td width="90" align="right">' . $Siltap . '</td>
            </tr>';
    $Nomor++;
}
$content .= '</tbody>
