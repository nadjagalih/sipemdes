...
if (isset($_GET['Proses'])) {
    ...
    $content =
        '<html>
            <body>
            <h4>Rekap Pendidikan Pemerintah Desa Kecamatan' . " " . $NamaKecamatan . '<br>Pertanggal ' . $Tanggal_Cetak . ' Pukul ' . $Waktu_Cetak . ' WIB</h4>
...
// $html2pdf->output();
$content2pdf->Output('Rekap Pendidikan Perangkat Desa Kecamatan ' . " " . $NamaKecamatan . '_' . $DateCetak . '.pdf', 'I'); //NAMA FILE, I/D/F/S
?>
