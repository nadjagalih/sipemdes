...
if (isset($_GET['Kecamatan'])) {
    if (isset($_GET['Desa'])) {
        ...
        $content =
            '<html>
            <body>
            <h4>Data Pensiun Pemerintahan Desa ' . " " . $NamaDesa . " " . 'Kecamatan' . " " . $NamaKecamatan . '<br>Pertanggal ' . $Tanggal_Cetak . ' Pukul ' . $Waktu_Cetak . ' WIB</h4>
                <table  border="0.3" cellpadding="2" cellspacing="0" width="100%">
                    <thead>
                        <tr align="center">
                            <th width="50"><strong><font size="12">No</font></strong></th>
                            <th width="90"><strong><font size="12">Foto</font></strong></th>
                            ...
                            <th width="80"><strong><font size="12">Tgl Lahir<br>Jenis Kelamin</font></strong></th>
                            <th width="85"><strong><font size="12">Tgl Pensiun</font></strong></th>
                            <th width="75"><strong><font size="12">Tgl SK Pensiun</font></strong></th>
                            <th width="150"><strong><font size="12">No SK Pensiun</font></strong></th>
                            <th width="150"><strong><font size="12">Unit Kerja<br>Kecamatan<br>Kabupaten</font></strong></th>
                        </tr>
                    </thead>
                    <tbody>';
