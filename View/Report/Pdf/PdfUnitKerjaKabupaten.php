...
$content = '<html><body>
        <h4><strong>Rekap Data Pemerintah Desa Kabupaten ' . $Kabupaten . ' PerKecamatan <br>Pertanggal ' . $Tanggal_Cetak . ' Pukul ' . $Waktu_Cetak . ' WIB</strong></h4>
...
// $html2pdf->output();
$content2pdf->Output('Rekap Jumlah Perangkat Desa Kabupaten ' . " " . $Kabupaten . '_' . $DateCetak . '.pdf', 'I'); //NAMA FILE, I/D/F/S
?>
