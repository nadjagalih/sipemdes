...
<form action="?pg=TerkiniPegawaiFilterDesa" method="post" enctype="multipart/form-data">
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox ">
    ...
    ?>
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>Desa <?php echo $NamaDesa; ?><br>Data Terkini Pemerintah Desa Berdasarkan Jabatan</h5>
                        <div class="ibox-tools">
                            <a class="collapse-link">
                                <i class="fa fa-chevron-up"></i>
                            </a>
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>Grafik Desa <?php echo $NamaDesa; ?><br>Data Terkini Pemerintah Desa Berdasarkan Jabatan</h5>
                        <div class="ibox-tools">
                            <a class="collapse-link">
                                <i class="fa fa-chevron-up"></i>
                            </a>
...
<script type="text/javascript">
    Highcharts.chart('GrafikJabatan', {
        ...
        title: {
            text: '<strong>Rekap Desa <?php echo $NamaDesa; ?> Kecamatan <?php echo $NamaKecamatan; ?></strong>'
        },
        subtitle: {
        ...
        series: [
            ...
            $QJabatan = mysqli_query($db, "SELECT
                    ...
                    master_desa.IdKecamatanFK = '$Kecamatan' AND
                    master_desa.IdDesa = '$Desa'
                    GROUP BY history_mutasi.IdPegawaiFK");
            while ($DataJabatan = mysqli_fetch_assoc($QJabatan)) {
