<script type="text/javascript">
    $(document).ready(function() {
        // Options are loaded directly in PHP, no AJAX needed
    });
</script>

<form action="Report/Pdf/PdfTerkiniPegawaiFilterKecamatan" method="GET" enctype="multipart/form-data" target="_BLANK">
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Filter Data Terkini PerKecamatan </h5>
