...
<script type="text/javascript">
    $(document).ready(function() {
        // Options loaded directly in PHP, no AJAX needed
    });
</script>

<form action="?pg=PendidikanFilterKecamatan" method="post" enctype="multipart/form-data">
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Filter Data Pendidikan PerKecamatan </h5>
    ...
    ?>
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>Filter Data Pendidikan Kecamatan <?php echo $NamaKecamatan; ?></h5>
                        <div class="ibox-tools">
                            <a class="collapse-link">
                                <i class="fa fa-chevron-up"></i>
                            </a>
