...
?>
<form action="?pg=FilterKecamatan" method="post" enctype="multipart/form-data">
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Filter Data Perangkat Desa Mendekati Masa Pensiun PerKecamatan </h5>
                ...
                <br><br><span style="font-style: italic; color:red">*) Laporan Dengan Warna </span><span style="background-color: aquamarine;">Background</span> <span style="font-style: italic; color:red">Adalah Perangkat Desa Dengan Masa Pensiun Kurang dari 5 Bulan</span>
            </div>
        </div>
    </div>
    ...
    ?>
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>Hasil Data Filter Perangkat Desa Kecamatan <?php echo $NamaKecamatan; ?></h5>
                        <div class="ibox-tools">
                            <a class="collapse-link">
                                <i class="fa fa-chevron-up"></i>
                            </a>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-kecamatan">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <?php if ($HasilTahun == 0 and $HasilBulan <= 4) {
                                        ?>
                                            <tr class="gradeX" style="background-color: aquamarine;">
                                                <td>
                                                    <?php echo $Nomor; ?>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                        ...
                                                        ?>
                                                            <br><br>
                                                            <span class="label label-info float-left">HARAP MELAKUKAN PENGISIAN</span>
                                                        <?php } ?>
