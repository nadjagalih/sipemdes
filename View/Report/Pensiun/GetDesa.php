...
if (!isset($db)) {
    error_log("Database connection not found in GetDesa.php (Pensiun module)");
...
error_log("GetDesa.php (Pensiun) received Kecamatan: " . $Kecamatan);
...
if (!$QueryDesa) {
    error_log("GetDesa.php (Pensiun) query error: " . mysqli_error($db));
...
error_log("GetDesa.php (Pensiun) found $resultCount desa records for Kecamatan: $Kecamatan");
