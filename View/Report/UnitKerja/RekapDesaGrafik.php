...
<div class="ibox-content">
    <div class="row">
        <div class="col-lg-6">
            <h4><strong>Data Pemerintah Desa Kecamatan <?php echo $NamaKecamatan; ?></strong></h4>
...
<script type="text/javascript">
    Highcharts.chart('GrafikDesa', {
        ...
        title: {
            text: '<strong>Grafik Pemerintah Desa Kecamatan <?php echo $NamaKecamatan; ?></strong>'
        },
        subtitle: {
