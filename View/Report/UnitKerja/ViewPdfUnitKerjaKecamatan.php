<script type="text/javascript">
    $(document).ready(function() {
        // Options loaded directly in PHP, no AJAX needed for Kecamatan
        $("#Kecamatan").change(function() {
            var Kecamatan = $("#Kecamatan").val();
            $.ajax({
                type: 'POST',
                url: "Report/UnitKerja/RekapDesaGrafik.php",
                data: {
                    Kecamatan: Kecamatan
                },
                cache: false,
                success: function(msg) {
                    $("#RekapDesaGrafik").html(msg);
                }
            });
        });
    });
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Filter Data Pemerintah Desa PerKecamatan </h5>
                ...
                <div class="ibox-content">
                    <div class=row>
                        <div class="col-lg-6">
                            ...
                            <a href="?pg=ReportUnitKerja"><button type="button" class="btn btn-outline btn-primary">Batal</button></a>
                        </div>
