...
if (isset($_GET['Proses'])) {
    ...
    $content =
        '<html>
            <body>
            <h4 align="center">PROFILE DATA</h4>
                ...
                <table border="0.1" cellpadding="6" cellspacing="0" width="100%">
                    <thead>
                        <tr align="center">
                            ...
                            <th width="120">Jenis Mutasi</th>
                            <th width="150">Jabatan</th>
                            <th width="120">Tanggal Mutasi</th>
                            <th width="90">Nomer SK<br>SK Mutasi</th>
    ...
    while ($DataView = mysqli_fetch_assoc($QMutasiView)) {
        ...
        $content .= '<tr>
                ...
                <td>' . $Jabatan . '</td>
                <td>' . $TanggalMutasi . '</td>
                <td>' . $NomorSK . '<br>' . $TanggalMutasi . '</td>
