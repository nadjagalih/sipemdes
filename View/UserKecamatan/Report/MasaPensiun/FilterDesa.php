...
<form action="?pg=FilterDesaKec" method="post" enctype="multipart/form-data">
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Filter Data Perangkat Desa Mendekati Masa Pensiun PerDesa Kecamatan <?php echo $Kecamatan; ?></h5>
                ...
                <div class="ibox-content">
                    <div class=row>
                        <div class="col-lg-6">
                            ...
                            <a href="?pg=ViewMasaPensiunKec"><button type="button" class="btn btn-outline btn-primary">Batal</button></a>
                        </div>
    ...
    ?>
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>Hasil Data Filter Perangkat Desa <?php echo $NamaDesa; ?> Kecamatan <?php echo $NamaKecamatan; ?></h5>
                        <div class="ibox-tools">
                            <a class="collapse-link">
                                <i class="fa fa-chevron-up"></i>
                            </a>
