...
?>
<form action="UserKecamatan/Report/MasaPensiun/PdfMasaPensiunDesa" method="GET" enctype="multipart/form-data" target="_BLANK">
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Filter Data Mendekati Masa Pensiun PerDesa Kecamatan <?php echo $Kecamatan; ?></h5>
