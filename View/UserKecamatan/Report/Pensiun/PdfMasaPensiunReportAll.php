...
if (!empty($filterDesa)) {
    ...
    $title = 'Data Perangkat Desa Mendekati Masa Pensiun ' . $filterDesa . ' Kecamatan ' . $NamaKecamatan;
    $filename = 'Data Masa Pensiun Desa ' . $filterDesa . ' Kecamatan ' . $NamaKecamatan . '_' . $DateCetak;
} else {
    $title = 'Data Perangkat Desa Mendekati Masa Pensiun Kecamatan ' . $NamaKecamatan;
    $filename = 'Data Masa Pensiun Kecamatan ' . $NamaKecamatan . '_' . $DateCetak;
}
            ...
            <table border="0.3" cellpadding="2" cellspacing="0" width="100%">
                <thead>
                    <tr align="center">
                        ...
                        <th><strong>Sisa Pensiun</strong></th>
...
while ($DataPegawai = mysqli_fetch_assoc($QueryPegawai)) {
    ...
    $content .= '<br>' . $JenisKelamin . '</td>
            ...
            <td width="160">' . $HasilTahun . " " . $HasilBulan . " " . $HasilHari . '</td>
