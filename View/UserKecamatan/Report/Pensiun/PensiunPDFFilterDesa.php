...
?>
<form action="UserKecamatan/Report/Pensiun/PdfPensiunFilterDesa" method="GET" enctype="multipart/form-data" target="_BLANK">
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Data Pensiun Kepala Desa & Perangkat Desa Kecamatan <?php echo $Kecamatan; ?> </h5>
                ...
                <div class="ibox-content">
                    <div class=row>
                        <div class="col-lg-6">
                            ...
                            <a href="?pg=ViewPensiunKec"><button type="button" class="btn btn-outline btn-primary">Batal</button></a>
                        </div>
