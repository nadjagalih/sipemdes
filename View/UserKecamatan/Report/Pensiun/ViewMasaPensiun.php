...
<div class="wrapper wrapper-content animated fadeInRight">
    <style>
        ...
        .masa-pensiun-table tbody tr[style*="background-color: #fecaca"] {
            background-color: #fecaca !important;
        }
        
        .masa-pensiun-table tbody tr[style*="background-color: #fecaca"]:hover {
        ...
        <div class="ibox ">
            ...
            <div class="ibox-content">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover masa-pensiun-table" id="masaPensiunTable">
...
$(document).ready(function() {
    console.log('Initializing Masa Pensiun DataTable with custom filters...');
    
    // Check if DataTable already exists and destroy it
    if ($.fn.DataTable.isDataTable('#masaPensiunTable')) {
        console.log('DataTable already exists, destroying...');
        $('#masaPensiunTable').DataTable().destroy();
    }
    
    // Initialize DataTable dengan konfigurasi yang tepat
    var table = $('#masaPensiunTable').DataTable({
        ...
        "buttons": [
            ...
            },
            {
                ...
                action: function (e, dt, node, config) {
                    ...
                    var pdfUrl = 'UserKecamatan/Report/Pensiun/PdfMasaPensiunReportAll.php';
    ...
    console.log('Masa Pensiun DataTable initialized successfully');
    ...
    setTimeout(function() {
        ...
        console.log('Masa Pensiun filters moved to custom container');
    }, 100);

    // Custom search input (use event delegation for moved elements)
    $(document).on('keyup', '#customSearchMoved', function() {
        console.log('Masa Pensiun search input:', this.value);
    ...
    $(document).on('change', '#desaFilterMoved', function() {
        ...
        console.log('Masa Pensiun desa filter changed to:', selectedDesa);
    ...
    setTimeout(function() {
        console.log('Masa Pensiun moved dropdown exists:', $('#desaFilterMoved').length > 0);
        console.log('Masa Pensiun moved search input exists:', $('#customSearchMoved').length > 0);
        console.log('Masa Pensiun custom filters container exists:', $('.custom-filters').length > 0);
    }, 200);
});
</script>